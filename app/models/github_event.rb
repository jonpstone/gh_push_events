class GithubEvent < ApplicationRecord
  ...
  before_validation :ensure_raw_payload
  ...
  def payload_changed_from_raw?
    payload != (raw_payload['payload'] || {})
  end

  private

  def ensure_raw_payload
    errors.add(:raw_payload, "cannot be empty") if raw_payload.blank?
  end
end